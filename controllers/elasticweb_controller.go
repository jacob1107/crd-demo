...
const (
	// APP_NAME deployment中的APP标签名
	APP_NAME = "elastic-app"
	// CONTAINER_PORT tomcat容器的端口号
	CONTAINER_PORT = 8080
...
func (r *ElasticWebReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	fmt.Println("jacob=====NamespacedName===", req.NamespacedName)
...
func (r *ElasticWebReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.Log = ctrl.Log.WithName("controllers").WithName("ElasticWeb")
